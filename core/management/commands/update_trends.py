...
class Command(BaseCommand):
    help = 'Update asset trends (day, week, month, year)'
    ...
    def handle(self, *args, **options):
        ...
        symbols = HistoricAsset.objects.values_list('symbol', flat=True).distinct()
        ...
        self.stdout.write(self.style.SUCCESS('Asset trends updated successfully.'))
