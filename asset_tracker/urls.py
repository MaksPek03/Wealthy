...
urlpatterns = [
    ...
    path('accounts/profile/wallets/<int:wallet_id>/add_wallet_asset/', views.wallet_assets, name='add_wallet_asset'),
    ...
    path('api/trends/<int:user_id>/', views.api_trends, name='api_trends'),
    ...
    path('api/friend_requests/', views.api_friend_requests_list, name='api_friend_requests_list'),
    path('friends/send-request/<int:user_id>/', views.send_friend_request, name='send_friend_request'),
    path('api/friends/send-request/<int:user_id>/', views.api_send_friend_request, name='api_send_friend_request'),
    ...
    path('api/friends/accept-request/<int:request_id>/', views.api_accept_friend_request, name='api_accept_friend_request'),
    path('api/friends/decline-request/<int:request_id>/', views.api_decline_friend_request, name='api_decline_friend_request'),
    ...
    path("api/group_list/<int:group_id>/buy/", views.api_buy_asset_in_group, name="api_buy_asset_in_group"),
    ...
    path("api/group_list/<int:group_id>/<int:request_id>/approve/", views.api_approve_request, name="api_approve_request"),
    path("api/group_list/<int:group_id>/<int:request_id>/reject/", views.api_reject_request, name="api_reject_request"),
    ...
    path('api/goals/delete/<int:goal_id>/', views.api_delete_user_goal, name='api_delete_user_goal'),
    path('my_alerts', views.my_alerts, name = 'my_alerts'),
    path('my_alerts/delete/<int:alert_id>/', views.delete_alert, name='delete_alert'),
    path('api/my_alerts/', views.api_my_alerts, name = 'api_my_alerts'),
    path('assets/<int:asset_id>/add-alert/', views.add_price_alert, name='add_price_alert'),
    path('api/assets/<int:asset_id>/add-alert/', views.api_add_price_alert, name='api_add_price_alert'),
